...
int main() {
    ...
    // calculando super poder da carta
    superPoder = populacaoCidade + areaCidade + pibCidade + pontosTuristicosCidadeQTD + pibPerCapita + (1 / densidadePopulacional);
    ...
    superPoder2 = populacaoCidade2 + areaCidade2 + pibCidade2 + pontosTuristicosCidadeQTD2 + pibPerCapita2 + (1 / densidadePopulacional2);

	// Calculo da disputa entre duas cartas
	int resultadoPopulacao = populacaoCidade > populacaoCidade2;
	int resultadoArea = areaCidade > areaCidade2;
	int resultadoPIB = pibCidade > pibCidade2;
	int resultadoPontosTuristicos = pontosTuristicosCidadeQTD > pontosTuristicosCidadeQTD2;
	int resultadoDensidadePopulacional = densidadePopulacional < densidadePopulacional2;
    ...
    printf("\nPopulação: Resultado disputa carta 1 vs 2: %d\n", resultadoPopulacao);
    printf("Área: Resultado disputa carta 1 vs 2: %d\n", resultadoArea);
    printf("PIB: Resultado disputa carta 1 vs 2: %d\n", resultadoPIB);
    printf("Pontos Turísticos: Resultado disputa carta 1 vs 2: %d\n", resultadoPontosTuristicos);
    printf("Densidade Populacional: Resultado disputa carta 1 vs 2: %d\n", resultadoDensidadePopulacional);
    printf("PIB per Capita: Resultado disputa carta 1 vs 2: %d\n", resultadoPIBPerCapita);
    printf("Super Poder: Resultado disputa carta 1 vs 2: %d\n", resultadoSuperPoder);
